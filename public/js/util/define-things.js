...
export const MAIN_PIC_PREV_SVG = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" width="30" height="30" data-label="main-pic-prev"><polyline points="15,6 9,12 15,18" data-label="main-pic-prev"></polyline></svg>`;

export const MAIN_PIC_NEXT_SVG = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" width="30" height="30" data-label="main-pic-next"><polyline points="9,6 15,12 9,18" data-label="main-pic-next"></polyline></svg>`;
